...
/**
 * Altitude range for a SIGMET phenomenon, typically expressed as
 * "BTN FL350 AND FL410" or "BTN SFC AND FL100".
 */
export interface SigmetAltitudeRange {
  /** Base altitude in feet MSL. Undefined when the base is the surface (SFC). */
  baseFt?: number;
...
export interface SigmetHazard {
  ...
  altitudeRange?: SigmetAltitudeRange;
