...
import { usBundledAirspaceProperties } from './meta.js';
import { usBundledAirspace } from './node.js';

describe('usBundledAirspaceProperties', () => {
  it('matches the metadata embedded in the bundled snapshot', () => {
    ...
    expect(usBundledAirspaceProperties).toEqual(usBundledAirspace.properties);
  });
});
