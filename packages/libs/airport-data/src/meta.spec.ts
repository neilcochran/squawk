...
import { usBundledAirportsProperties } from './meta.js';
import { usBundledAirports } from './node.js';

describe('usBundledAirportsProperties', () => {
  it('matches the metadata embedded in the bundled snapshot', () => {
    ...
    expect(usBundledAirportsProperties).toEqual(usBundledAirports.properties);
  });
});
