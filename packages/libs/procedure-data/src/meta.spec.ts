...
import { usBundledProceduresProperties } from './meta.js';
import { usBundledProcedures } from './node.js';

describe('usBundledProceduresProperties', () => {
  it('matches the metadata embedded in the bundled snapshot', () => {
    ...
    expect(usBundledProceduresProperties).toEqual(usBundledProcedures.properties);
  });
});
