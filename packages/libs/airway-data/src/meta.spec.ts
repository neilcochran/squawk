...
import { usBundledAirwaysProperties } from './meta.js';
import { usBundledAirways } from './node.js';

describe('usBundledAirwaysProperties', () => {
  it('matches the metadata embedded in the bundled snapshot', () => {
    ...
    expect(usBundledAirwaysProperties).toEqual(usBundledAirways.properties);
  });
});
