...
Pre-processed snapshot of US aircraft registrations from the **2026-06-14** FAA ReleasableAircraft database. Data only - no dependency on `@squawk/icao-registry`. Versioned and released independently.
