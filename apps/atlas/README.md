...
A **Reset to defaults** row at the foot of the menu returns every layer, airspace class, and airway category to its default state in one click, and stays inert while the menu already matches the defaults.
