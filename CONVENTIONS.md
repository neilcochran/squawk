...
The cross-cutting rules in this file (TSDoc, naming, unit suffixes, code style, ESLint) apply to the apps under [`apps/`](apps/) as well; each app's own `CONVENTIONS.md` covers the framework patterns specific to it.
