...
| [`@squawk/adsbscope`](https://github.com/neilcochran/squawk/tree/main/apps/adsbscope) | ATC-style radar scope for live ADS-B traffic, served to your browser by a small CLI built on `@squawk/adsb-feed`. Published to npm. |
...
Working on the repo requires the Node version in [.nvmrc](.nvmrc) (currently 24) or newer. The published `@squawk/*` packages support Node 22 and newer.
